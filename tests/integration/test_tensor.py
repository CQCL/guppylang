...
def test_check_callable(validate):
    ...
    validate(guppy.compile(baz1))
    validate(guppy.compile(baz2))
...
def test_call(validate):
    ...
    validate(guppy.compile(baz_ho_call))
    validate(guppy.compile(baz))
    validate(guppy.compile(call_var))
