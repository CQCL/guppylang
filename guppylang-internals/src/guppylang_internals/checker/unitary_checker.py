...
class BBUnitaryChecker(ast.NodeVisitor):
    ...
    """AST visitor that checks whether the modifiers (dagger, control, power) are applicable."""
...
def check_cfg_unitary(
    ...
    print("[CheckPoint]: Unitarity Check start")
    print("  unitary_flags @ unitarity checker:", unitary_flags)
    bb_checker = BBUnitaryChecker()
    for bb in cfg.bbs:
        bb_checker.check(bb, unitary_flags)

    print("[CheckPoint]: Unitarity Check end")
    pass
