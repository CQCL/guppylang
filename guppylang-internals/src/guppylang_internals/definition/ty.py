...
class TypeDef(Definition):
    ...
    #: more polymorphic than the regular type system allows (for example `Callable`),
    #: or if this is a raw definition whose parameters are not determined yet (for
    #: example a `RawStructDef`).
