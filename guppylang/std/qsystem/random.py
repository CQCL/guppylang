...
class RNGContext:
    @guppy.hugr_op(
        external_op("NewRNGContext", [int], ext=QSYSTEM_RANDOM_EXTENSION),
    ...
    @guppy.hugr_op(
        external_op("DeleteRNGContext", [int], ext=QSYSTEM_RANDOM_EXTENSION),
        module=qsystem_random,
    )
    @no_type_check
    ...
    @guppy.hugr_op(
        external_op("RandomInt", [RNGCONTEXT_T], ext=QSYSTEM_RANDOM_EXTENSION),
        module=qsystem_random,
    )
    @no_type_check
    ...
    @guppy.hugr_op(
        external_op("RandomFloat", [RNGCONTEXT_T], ext=QSYSTEM_RANDOM_EXTENSION),
        module=qsystem_random,
    )
    @no_type_check
    ...
    @guppy.hugr_op(
        external_op(
            "RandomIntBounded", [RNGCONTEXT_T, int], ext=QSYSTEM_RANDOM_EXTENSION
        ),
        module=qsystem_random,
    )
    @no_type_check
